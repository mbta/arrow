...
var adjustmentSummary_1 = require("../../src/disruptions/adjustmentSummary")
var adjustment_1 = __importDefault(require("../../src/models/adjustment"))
describe("AdjustmentSummary", function () {
  test("renders the adjustments onto the page", function () {
