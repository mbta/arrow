defmodule Arrow.Shuttles do
  ...
  @doc """
  Returns the list of shuttle_route_stops.

  ## Examples

      iex> list_shuttle_route_stops()
      [%ShuttleRouteStops{}, ...]

  """
  def list_shuttle_route_stops do
    Repo.all(ShuttleRouteStops)
  end

  @doc """
  Gets a single shuttle_route_stops.

  Raises `Ecto.NoResultsError` if the Shuttle route stops does not exist.

  ## Examples

      iex> get_shuttle_route_stops!(123)
      %ShuttleRouteStops{}

      iex> get_shuttle_route_stops!(456)
      ** (Ecto.NoResultsError)

  """
  def get_shuttle_route_stops!(id), do: Repo.get!(ShuttleRouteStops, id)

  @doc """
  Creates a shuttle_route_stops.

  ## Examples

      iex> create_shuttle_route_stops(%{field: value})
      {:ok, %ShuttleRouteStops{}}

      iex> create_shuttle_route_stops(%{field: bad_value})
      {:error, %Ecto.Changeset{}}

  """
  def create_shuttle_route_stops(attrs \\ %{}) do
    %ShuttleRouteStops{}
    |> ShuttleRouteStops.changeset(attrs)
    |> Repo.insert()
  end

  @doc """
  Updates a shuttle_route_stops.

  ## Examples

      iex> update_shuttle_route_stops(shuttle_route_stops, %{field: new_value})
      {:ok, %ShuttleRouteStops{}}

      iex> update_shuttle_route_stops(shuttle_route_stops, %{field: bad_value})
      {:error, %Ecto.Changeset{}}

  """
  def update_shuttle_route_stops(%ShuttleRouteStops{} = shuttle_route_stops, attrs) do
    shuttle_route_stops
    |> ShuttleRouteStops.changeset(attrs)
    |> Repo.update()
  end
  ...
  @doc """
  Deletes a shuttle_route_stops.

  ## Examples

      iex> delete_shuttle_route_stops(shuttle_route_stops)
      {:ok, %ShuttleRouteStops{}}
  ...
  """
  def delete_shuttle_route_stops(%ShuttleRouteStops{} = shuttle_route_stops) do
    Repo.delete(shuttle_route_stops)
  end

  @doc """
  Returns an `%Ecto.Changeset{}` for tracking shuttle_route_stops changes.

  ## Examples

      iex> change_shuttle_route_stops(shuttle_route_stops)
      %Ecto.Changeset{data: %ShuttleRouteStops{}}

  """
  def change_shuttle_route_stops(%ShuttleRouteStops{} = shuttle_route_stops, attrs \\ %{}) do
    ShuttleRouteStops.changeset(shuttle_route_stops, attrs)
  end
end
