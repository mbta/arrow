defmodule ArrowWeb.CoreComponents do
  @moduledoc """
  ...
  def input(%{type: "checkbox"} = assigns) do
    ...
    <div class="form-group">
      <label class="gap-4 text-sm leading-6 text-zinc-600">
  ...
  I stole this from Chris McCord here: https://github.com/phoenixframework/phoenix/pull/5506
