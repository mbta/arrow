...
alias Arrow.Shuttles.{Shape, Stop, Shuttle, ShuttleRoute, ShuttleRouteStops}
...
Repo.insert! %ShuttleRouteStops{
  ...
  stop_sequence: 3,
  stop_id: "9070072",
  time_to_next_stop: nil, # last shuttle stop
  shuttle_route_id: 3
}
