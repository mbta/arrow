    ...
    test "extracts data from export", %{export: export} do
      ...
      expected_services = [
        ...
        %{
          ...
          derived_limits: [%{start_stop_id: "70038", end_stop_id: "70040"}]
        }
      ]
    ...
    test "OL export", %{export: export} do
      ...
      expected_services = [
        %{
          ...
          derived_limits: [%{start_stop_id: "70027", end_stop_id: "70036"}]
        },
        %{
    ...
    test "a complex GL export", %{export: export} do
      ...
      expected_services = [
        %{
          ...
          derived_limits: [
            %{start_stop_id: "70201", end_stop_id: "70503"},
            %{start_stop_id: "70201", end_stop_id: "70511"}
          ]
        },
        %{
    ...
    test "an especially complex GL export", %{export: export} do
      ...
      expected_services = [
        %{
          ...
          derived_limits: [
            # Babcock to Copley
            %{start_stop_id: "170136", end_stop_id: "70154"},
            # Babcock to North Station
            %{start_stop_id: "170136", end_stop_id: "70205"},
            # Heath St to North Station
            %{start_stop_id: "70260", end_stop_id: "70205"}
          ]
        },
        %{
